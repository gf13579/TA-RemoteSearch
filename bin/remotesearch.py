...
class remotesearchCommand(GeneratingCommand):
    ...
    def generate(self):
        ...
        api_search = splunklib_search.splunklib_search(base_url=base_url, username=username, password=password, auth_token=auth_token, logger_name=self.logger.name, check_cert=check_cert)
