...
const appName = "TA-RemoteSearch";
const appNamespace = {
    owner: "nobody",
    app: appName,
    sharing: "app",
};
const pwRealm = "TA-RemoteSearch_realm";
...
require([
    ...
    async function completeSetup() {
        ...
        // const passwordToSave = $('#username_input').val() + '---' + $('#password_input').val();
        const credsToSave = {'username' : $('#username_input').val(), 'password': $('#password_input').val(), 'auth_token': $('#auth_token_input').val()}
        const passwordToSave =  JSON.stringify(credsToSave);
